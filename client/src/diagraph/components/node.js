...
class Node extends React.Component {
  ...
  renderShape() {
    ...
    const nodeBorderClass = data.type==='rule'? 'rule-'+data.effect : data.type
    const nodeShapeContainerClassName = GraphUtils.classNames('shape');
    const nodeClassName = GraphUtils.classNames('node', nodeBorderClass, { selected, hovered });
    ...
    const defSvgNodeElement = nodeTypeXlinkHref ? document.querySelector(`defs>${nodeTypeXlinkHref}`) : null;
